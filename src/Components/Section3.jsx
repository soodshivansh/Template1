...
function section3() {
  ...
  return (
    ...
    <div className='flex justify-center items-center flex-col pt-10 gap-4 mt-10 p-5'>
        ...
        <h1 className='font-Kanit lg:text-6xl md:text-5xl sm:text-4xl text-3xl font-medium text-center'>Everything should be this easy.</h1>
    </div>
    <div className='flex md:flex-row flex-col justify-around p-10'>
      <div className='p-10 flex flex-col text-center md:text-left'>
        <i class="fa-solid fa-id-card text-7xl pb-3" style={{"color": "#243a61"}}></i>      
      ...
      <div className='p-10 flex flex-col text-center md:text-left'>
        <i class="fa-solid fa-people-arrows text-7xl pb-3 text-[#48a446]"></i>
      ...
      <div className='p-10 flex flex-col text-center md:text-left'>
        <i class="fa-solid fa-building-shield text-7xl pb-3 text-[#a87549]"></i>
